          ...
          <div className="lg:col-span-5 space-y-4">
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-xl font-extrabold text-white tracking-tight">
                Shadow<span className="text-blue-500">Arrow</span>
              </span>
            </div>
          ...
          <div className="lg:col-span-4 space-y-3">
            ...
            <div className="space-y-2.5 text-xs text-slate-300">
              <div className="flex items-center gap-2">
                ...
                <a href="mailto:bijoy@shadowarrow.com" className="hover:text-white transition-colors">
                  bijoy@shadowarrow.com
                </a>
              </div>
              <div className="flex items-center gap-2">
                ...
                <a href="https://wa.me/919876543210" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
                  +91 98765 43210 (WhatsApp Direct)
                </a>
              </div>
